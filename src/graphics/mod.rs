...
use self::editing::{person::{person_editing_system, person_listing_system, PersonListWindowOpen}, factions::{FactionListWindowOpen, faction_listing_system, faction_editing_system}, params::{SimulationSettingsWindowOpen, simulation_parameters_settings_window_system}, species::{SpeciesListWindowOpen, species_listing_system, species_editing_system}, map::{MapConfigWindowOpen, map_config_window_system, generation_progress_window_system}};
...
impl Plugin for GraphicsPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.insert_resource(MapConfigWindowOpen(false));
        app.add_systems(Update, map_config_window_system);
        app.add_systems(Update, person_editing_system);
        app.add_systems(Update, faction_editing_system);
        app.add_systems(Update, species_editing_system);
        app.add_systems(Update, generation_progress_window_system);
    }
}
